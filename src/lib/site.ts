...
export const corporateFaqs = [
  ...
  },
  {
    ...
    a: "We'll respond within 2 hours. Timeline depends on scale and date — share your brief and we'll propose a clear next step.",
  },
] as const;
...
export const enquireFaqs = [
  {
    ...
    a: "Within 2 hours on working days. Urgent dates — say so in your enquiry and WhatsApp us directly.",
  },
  {
