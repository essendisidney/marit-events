...
export const metadata: Metadata = {
  ...
  description:
    "Tell Marit Events about your celebration. We'll reply within 2 hours max.",
          ...
          <Reveal>
            <div className="md:hidden">
              <SectionHeading
                ...
                body="Share the essentials. We'll respond with care — and clarity — within 2 hours max."
              />
            </div>
            ...
            <ol className="mt-8 hidden space-y-3 text-sm text-taupe md:block">
              ...
              <li>
                <span className="text-champagne">02</span> We reply within 2 hours
                max
              </li>
              <li>
